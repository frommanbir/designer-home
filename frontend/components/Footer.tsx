      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-2">
          ...
          <ul className="space-y-4 text-white/70 font-medium text-lg font-inter">
            <li>
              <Link href="/" className="hover:text-[#C59D5F] transition-colors">
                Home
              </Link>
            </li>
            <li>
        ...
        <div className="lg:col-span-4">
          ...
          <div className="space-y-6 text-white/80 font-normal font-inter">
            <p className="flex items-start gap-3">
              <MapPin className="text-[#C59D5F] w-5 h-5 flex-shrink-0 mt-0.5" />
              <span className="flex-1">
                {contact.address || "Naxal, Kathmandu, Nepal 44600"}
              </span>
            </p>
            <p className="flex items-start gap-3">
              <Mail className="text-[#C59D5F] w-5 h-5 flex-shrink-0 mt-0.5" />
              <span className="flex-1 break-all">
                {contact.email || "info@designerhomenepal.com"}
              </span>
            </p>
            <p className="flex items-start gap-3">
              <Phone className="text-[#C59D5F] w-5 h-5 flex-shrink-0 mt-0.5" />
              <span className="flex-1">
        ...
        <div className="lg:col-span-3">
          ...
          <p className="text-white/60 text-sm leading-relaxed mb-6 font-inter">
            Follow us on social media for the latest design inspiration,
            updates, and sneak peeks of our projects.
          </p>
          <div className="flex gap-4">
            {[
              {
                icon: FaFacebook,
                link: socials.facebook || "https://facebook.com",
                label: "Facebook",
              },
              {
                icon: FaInstagram,
                link: socials.instagram || "https://instagram.com",
                label: "Instagram",
              },
              {
                icon: FaTwitter,
                link: socials.twitter || "https://twitter.com",
                label: "Twitter",
              },
            ].map((soc, i) => (
              <a
