...
function AboutPageContent() {
  ...
  const activeTab = searchParams.get("tab") || "why_choose";
  ...
  const tabLabel: Record<string, string> = {
    ...
    main_about: "Main About Content",
    why_choose: "Why Choose Us Features",
  };
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div>
        <h1 className="text-2xl font-bold text-neutral-900">About Setup — {tabLabel[activeTab] ?? "Hero Banner"}</h1>
