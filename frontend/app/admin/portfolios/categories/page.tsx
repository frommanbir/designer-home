...
export default function PortfolioCategoriesPage() {
  ...
  const handleDelete = async (id: number) => {
    if (!confirm("Are you sure? This will affect all portfolios in this category.")) return;
  ...
  const handleOpenModal = (category?: PortfolioCategory) => {
    if (category) {
      setIsEditing(true);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isEditing && currentCategory.id) {
        await updatePortfolioCategory(currentCategory.id, currentCategory);
        toast.success("Category updated successfully");
      } else {
        await createPortfolioCategory(currentCategory);
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-neutral-500 mt-1">Organize your portfolio works into distinct categories.</p>
          </div>
        </div>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    placeholder="e.g. Residential Luxury"
